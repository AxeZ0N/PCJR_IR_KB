...
void pcjrInit(void)
{
// --- INITIALIZATION VIA NATIVE REGISTERS ---
DDRE |= (1 << PE3);    // Replaces pinMode(5, OUTPUT) - Sets PE3 to OUTPUT

// Configure Timer 3 into CTC Mode 4 (Top defined by OCR3A)
TCCR3A = 0; 
TCCR3B = (1 << WGM32) | (1 << CS30); // CTC Mode 4, Prescaler = 1

// Set half-period for 40 kHz square wave toggling (16MHz / (2 * 40000)) - 1
OCR3A = 199;
    
}

#define PWM_ON TCCR3A |= (1 << COM3A0)
#define PWM_OFF TCCR3A &= ~(1 << COM3A0); PORTE |= (1 << PE3)
